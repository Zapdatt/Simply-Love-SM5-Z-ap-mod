...
elseif string.find(string.upper(GAMESTATE:GetCurrentSong():GetGroupName()), "STAMINA RPG 10") then
	text = "Stamina RPG 10"
	
elseif string.find(string.upper(GAMESTATE:GetCurrentSong():GetGroupName()), "ITL ONLINE 2026") then
	text = "ITL Online 2026"
